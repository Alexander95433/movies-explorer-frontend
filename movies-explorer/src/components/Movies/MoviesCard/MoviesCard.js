...
//             })
//             // debugger
//             props.hendleDeleteMovies(ff[0]._id, setisLiked)
//             deleteSavedFilmsFromLocalStorege({ card: props.card })
//         } else {
//             // debugger
//             props.hendleSaveMovies(props.card, setisLiked)
//         }
//         // debugger
//     };

//     function handleDeleteButtonCard(evt, setCheckDelete) {
//         props.hendleDeleteMovies(savedId, setCheckDelete)
//         deleteSavedFilmsFromLocalStorege( {card: props.card}  )
//     };
